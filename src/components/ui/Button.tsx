...
const base =
  'inline-flex items-center justify-center gap-2 rounded-lg font-semibold transition-all duration-200 select-none ' +
...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-surface text-slate-700 border border-line shadow-xs hover:border-line-strong hover:bg-canvas-3 hover:text-slate-900',
  ghost: 'text-slate-600 hover:text-slate-900 hover:bg-canvas-2',
  onDark:
